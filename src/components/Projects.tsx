      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2">
        {projects.map((project, index) => (
          <motion.a
            ...
            className="group relative px-5 py-8 sm:px-8 sm:py-12 min-h-[200px] sm:min-h-[300px] flex flex-col rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300"
